...
----------------
Base class for Single-Input-Mingle-Output (SIMO) models
"""
import typing as tp
...
class SIMOBase(nn.Module):
    ...
    def train_step(
        ...
        for name, module in self.loss_modules.items():
            losses.update(module(pred, sources))
